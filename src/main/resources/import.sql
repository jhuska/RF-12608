insert into Member (memberId, name) values (1, 'John Smith');
insert into Member (memberId, name) values (2, 'Andrew Robinson');
insert into Member (memberId, name) values (3, 'Foo Bar');
